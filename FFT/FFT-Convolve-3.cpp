 ...
 * UCID: 30122283
 * Date: Dec. 5th, 2023
 * Class Description: A program based on the FFT-Convolve-2 program, with applying the third code-tuning technique optimization. 
    The program should be invoked from the command line as follows: FFT-Convolve-3 inputfile IRfile outputfile
 */
